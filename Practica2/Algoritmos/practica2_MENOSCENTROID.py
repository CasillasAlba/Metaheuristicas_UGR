...
def cruce(num_esperado_cruces, poblacion, n_genes,d, datos,restricciones,valor_lambda,num_evaluaciones):
    ...
    if elitista == True:
        while contador < num_esperado_cruces:
            ...
            recalcular_centroides(datos, otro_hijo.valores_asignados, otro_hijo.centroides, d)
            otro_hijo.vf_objetivo = f_objetivo(datos, otro_hijo.valores_asignados, restricciones, n, d, otro_hijo.centroides, valor_lambda)
            num_evaluaciones = num_evaluaciones + 1
