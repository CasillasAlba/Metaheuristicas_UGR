...
def LocalSearch(datos, restricciones, n, d):
    ...
    hay_cambio = recalcular_centroides(datos, v_solucion, v_centroides, d)
    ...
    while(hay_cambio == 1) and (contador < MAX_ITER):
        ...
        for v in vecinos:
            sol1 = f_objetivo(datos, v, restricciones, n, d, centroides, valor_lambda)
            #print("solucion UNO", sol1)
            sol2 = f_objetivo(datos, v_solucion, restricciones, n, d, centroides, valor_lambda)
            #print("solucion DOS ", sol2)
            if sol1 < sol2 :
                v_solucion = v
                hay_cambio = 1
                break
